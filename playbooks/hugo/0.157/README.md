...
A fast and flexible open-source static site generator. Scaffolds a new site by default.
...
Hugo from example generates static files but does not serve them. Use nginx to serve the output:
